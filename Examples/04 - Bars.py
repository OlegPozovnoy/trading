...
def SaveCandlesToFile(classCode='TQBR', secCodes=('SBER',), timeFrame='D', compression=1,
    ...
    for secCode in secCodes:  # Пробегаемся по всем тикерам
        fileName = f'./Data/{classCode}.{secCode}_{timeFrame}{compression}.csv'
...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    SaveCandlesToFile(classCode, secCodes, 'M', 1, skipFirstDate=False, skipLastDate=False)  # 5-и минутные бары
