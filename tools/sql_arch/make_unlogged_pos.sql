...
CREATE UNLOGGED TABLE IF NOT EXISTS public.pos_collat
(
...
CREATE UNLOGGED TABLE IF NOT EXISTS public.pos_eq
(
    instrument character varying(32) COLLATE pg_catalog."default",
    pos bigint,
...
CREATE UNLOGGED TABLE IF NOT EXISTS public.pos_fut
(
    code character varying(16) COLLATE pg_catalog."default",
    instrument character varying(32) COLLATE pg_catalog."default",
    maturity date,
...
CREATE UNLOGGED TABLE IF NOT EXISTS public.pos_money
(
