...
CREATE  TABLE IF NOT EXISTS public.orders_my
(
...
CREATE  TABLE IF NOT EXISTS public.diffhist_t1510
(
    index bigint,
...
CREATE  TABLE IF NOT EXISTS public.orders_event_activator_jumps
(
...
CREATE  TABLE IF NOT EXISTS public.orders_event_activator_news
(
    id bigint NOT NULL DEFAULT nextval('orders_activator_shared_sequence'::regclass),
...
CREATE  TABLE IF NOT EXISTS public.orders_event_activator_price
(
    id bigint NOT NULL DEFAULT nextval('orders_activator_shared_sequence'::regclass),
    ticker character varying(16) COLLATE pg_catalog."default" NOT NULL,
