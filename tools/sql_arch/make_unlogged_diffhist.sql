...
CREATE UNLOGGED TABLE IF NOT EXISTS public.secquotesdiff
(
...
CREATE UNLOGGED TABLE IF NOT EXISTS public.futquotesdiff
(
    code character varying(16) COLLATE pg_catalog."default" NOT NULL,
    bid double precision,
    bidamount double precision,
...
CREATE UNLOGGED TABLE IF NOT EXISTS public.func_stats
(
...
CREATE UNLOGGED TABLE IF NOT EXISTS public.deals_ba
(
    code character varying(16) COLLATE pg_catalog."default" NOT NULL,
    bid bigint,
